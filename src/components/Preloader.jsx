    ...
    <AnimatePresence>
      {isLoading && (
        <motion.div
          ...
          className="fixed inset-0 w-full h-screen bg-purple-500 z-[100000] flex items-center justify-center"
        >
          {/* Logo Container */}
          <motion.div 
          ...
          >
            ...
            <div className="text-purple-900/30">
              WELCOME TO MY PORTFOLIO <span className="text-purple-900/30">.</span>
            </div>
            ...
            >
              Aashu Saini<span className="text-black">.</span>
            </motion.div>
          </motion.div>
